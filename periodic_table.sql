...
COPY public.elements_elements ("atomic_number", "element", "symbol", "atomic_mass", "number_of_neutrons", "number_of_protons", "number_of_electrons", "period", "group", "phase", "radioactive", "natural", "metal", "nonmetal", "metalloid", "type", "atomic_radius", "electronegativity", "first_ionization", "density", "melting_point", "boiling_point", "number_of_isotopes", "discoverer", "year", "specific_heat", "number_of_shells", "number_of_valence") FROM stdin;
...
--    ADD CONSTRAINT periodic_table_pkey PRIMARY KEY ("atomic_number");
